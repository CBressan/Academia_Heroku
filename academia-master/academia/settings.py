...
''' vai montar a url de banco de dados, considerando o sqlite3 para o ambiente local, e se encontrar configuração de banco
de dados, ela será usada '''
...
AUTH_USER_MODEL = 'alunos.Aluno_Usuario'
